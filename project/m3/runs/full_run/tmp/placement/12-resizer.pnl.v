module top (clk,
 ...
 sky130_fd_sc_hd__clkbuf_2 _2324_ (.A(_1816_),
    ...
    .VPWR(VPWR),
    .X(_1817_));
 sky130_fd_sc_hd__clkbuf_4 _2325_ (.A(\u_interface.u_compute_core.relu_data[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and3b_1 _2326_ (.A_N(_1817_),
    ...
    .VPWR(VPWR),
    .X(_1819_));
 sky130_fd_sc_hd__a31o_1 _2327_ (.A1(\u_interface.u_compute_core.scaled_data[0] ),
    .A2(_1813_),
    .A3(_1815_),
    .B1(_1819_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_2 _2328_ (.A(net2),
    ...
    .VPWR(VPWR),
    .X(_1820_));
 sky130_fd_sc_hd__clkbuf_4 _2329_ (.A(\u_interface.u_compute_core.relu_data[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _2345_ (.A(_1832_),
    ...
    .VPWR(VPWR),
    .Y(_1833_));
 sky130_fd_sc_hd__o2bb2a_1 _2346_ (.A1_N(\u_interface.u_compute_core.scaled_data[5] ),
    .A2_N(_1815_),
    .B1(_1833_),
    .B2(_1817_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_2 _2358_ (.A(\u_interface.u_compute_core.scaled_valid ),
    ...
    .VPWR(VPWR),
    .X(_1843_));
 sky130_fd_sc_hd__o2bb2a_1 _2359_ (.A1_N(\u_interface.u_compute_core.scaled_data[8] ),
    .A2_N(_1815_),
    .B1(_1842_),
    .B2(_1843_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _2362_ (.A(_1845_),
    ...
    .VPWR(VPWR),
    .Y(_1846_));
 sky130_fd_sc_hd__o2bb2a_1 _2363_ (.A1_N(\u_interface.u_compute_core.scaled_data[9] ),
    .A2_N(_1815_),
    .B1(_1846_),
    .B2(_1843_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _2368_ (.A(_1850_),
    ...
    .VPWR(VPWR),
    .Y(_1851_));
 sky130_fd_sc_hd__o2bb2a_1 _2369_ (.A1_N(\u_interface.u_compute_core.scaled_data[10] ),
    .A2_N(_1849_),
    .B1(_1851_),
    .B2(_1843_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _2429_ (.A(\u_interface.u_compute_core.relu_data[26] ),
    ...
    .VPWR(VPWR),
    .Y(_1896_));
 sky130_fd_sc_hd__o2bb2a_1 _2430_ (.A1_N(\u_interface.u_compute_core.scaled_data[26] ),
    .A2_N(_1814_),
    .B1(_1896_),
    .B2(_1816_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _2537_ (.A1(\u_interface.u_compute_core.u_mac.product_reg[0] ),
    ...
    .VPWR(VPWR),
    .X(_1971_));
 sky130_fd_sc_hd__nor2_1 _2538_ (.A(_1970_),
    .B(_1971_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _2606_ (.A(_2027_),
    ...
    .VPWR(VPWR),
    .Y(_2031_));
 sky130_fd_sc_hd__a22o_1 _2607_ (.A1(\u_interface.u_compute_core.mac_accum[9] ),
    .A2(_2026_),
    .B1(_2031_),
    .B2(_1973_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _2615_ (.A(_2032_),
    ...
    .VPWR(VPWR),
    .Y(_2039_));
 sky130_fd_sc_hd__o211a_1 _2616_ (.A1(\u_interface.u_compute_core.mac_accum[10] ),
    .A2(_1969_),
    .B1(_2039_),
    .C1(net62),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _2621_ (.A(_2040_),
    ...
    .VPWR(VPWR),
    .Y(_2044_));
 sky130_fd_sc_hd__a22o_1 _2622_ (.A1(\u_interface.u_compute_core.mac_accum[11] ),
    .A2(_2026_),
    .B1(_2044_),
    .B2(_1973_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _2629_ (.A1(_2048_),
    ...
    .VPWR(VPWR),
    .Y(_2051_));
 sky130_fd_sc_hd__a22o_1 _2630_ (.A1(\u_interface.u_compute_core.mac_accum[12] ),
    .A2(_2026_),
    .B1(_2049_),
    .B2(_2051_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or3_1 _2678_ (.A(_2003_),
    ...
    .VPWR(VPWR),
    .X(_2093_));
 sky130_fd_sc_hd__o211a_1 _2679_ (.A1(\u_interface.u_compute_core.mac_accum[19] ),
    .A2(_1969_),
    .B1(_2093_),
    .C1(net62),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31a_1 _2727_ (.A1(_2133_),
    ...
    .VPWR(VPWR),
    .X(_2135_));
 sky130_fd_sc_hd__a22o_1 _2728_ (.A1(\u_interface.u_compute_core.mac_accum[26] ),
    .A2(_2026_),
    .B1(_2134_),
    .B2(_2135_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _2732_ (.A1(_2136_),
    ...
    .VPWR(VPWR),
    .Y(_2139_));
 sky130_fd_sc_hd__a22o_1 _2733_ (.A1(\u_interface.u_compute_core.mac_accum[27] ),
    .A2(_2026_),
    .B1(_2138_),
    .B2(_2139_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _2752_ (.A(_2003_),
    ...
    .VPWR(VPWR),
    .X(_2156_));
 sky130_fd_sc_hd__o211a_1 _2753_ (.A1(\u_interface.u_compute_core.mac_accum[30] ),
    .A2(_1969_),
    .B1(_2156_),
    .C1(net62),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _2757_ (.A1(_2157_),
    ...
    .VPWR(VPWR),
    .Y(_2160_));
 sky130_fd_sc_hd__a22o_1 _2758_ (.A1(\u_interface.u_compute_core.mac_accum[31] ),
    .A2(_2026_),
    .B1(_2159_),
    .B2(_2160_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _2843_ (.A(_2238_),
    ...
    .VPWR(VPWR),
    .X(_2240_));
 sky130_fd_sc_hd__a22o_1 _2844_ (.A1(\u_interface.u_compute_core.u_mac.product_reg[5] ),
    .A2(_2026_),
    .B1(_2240_),
    .B2(_1973_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _3156_ (.A1(_0387_),
    ...
    .VPWR(VPWR),
    .Y(_0409_));
 sky130_fd_sc_hd__and2_1 _3157_ (.A(\u_interface.u_compute_core.u_mac.product_reg[14] ),
    .B(_1979_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _3195_ (.A1(_1968_),
    ...
    .VPWR(VPWR),
    .X(_0112_));
 sky130_fd_sc_hd__clkbuf_4 _3196_ (.A(\u_interface.u_compute_core.u_av.v_extended[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _3217_ (.A(\u_interface.u_compute_core.relu_data[3] ),
    ...
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__clkbuf_2 _3218_ (.A(\u_interface.u_compute_core.u_av.v_extended[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_1 _3226_ (.A1(_0431_),
    ...
    .VPWR(VPWR),
    .Y(_0467_));
 sky130_fd_sc_hd__buf_2 _3227_ (.A(_0436_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand4_2 _3246_ (.A(_0441_),
    ...
    .VPWR(VPWR),
    .Y(_0486_));
 sky130_fd_sc_hd__nand4_1 _3247_ (.A(_0483_),
    .B(_1824_),
    .C(_0485_),
    .D(_0486_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _3248_ (.A1(\u_interface.u_compute_core.u_av.v_extended[2] ),
    ...
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__and3_1 _3249_ (.A(_0469_),
    .B(_0487_),
    .C(_0488_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _3258_ (.A(_0496_),
    ...
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__xnor2_1 _3259_ (.A(_0482_),
    .B(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0499_));
 sky130_fd_sc_hd__xnor2_1 _3260_ (.A(_0464_),
    .B(_0499_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _3263_ (.A(_0478_),
    ...
    .VPWR(VPWR),
    .X(_0503_));
 sky130_fd_sc_hd__or2_1 _3264_ (.A(\u_interface.core_attn_out[1] ),
    .B(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _3265_ (.A1(_0480_),
    ...
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__and2_1 _3266_ (.A(_0475_),
    .B(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2b_1 _3286_ (.A(_0489_),
    ...
    .VPWR(VPWR),
    .X(_0525_));
 sky130_fd_sc_hd__nand3_1 _3287_ (.A(_0523_),
    .B(_0524_),
    .C(_0525_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _3288_ (.A1(_0523_),
    ...
    .VPWR(VPWR),
    .X(_0527_));
 sky130_fd_sc_hd__nand3_1 _3289_ (.A(_0506_),
    .B(_0526_),
    .C(_0527_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _3291_ (.A1(_0464_),
    ...
    .VPWR(VPWR),
    .X(_0530_));
 sky130_fd_sc_hd__nand3_1 _3292_ (.A(_0528_),
    .B(_0529_),
    .C(_0530_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _3312_ (.A(_0548_),
    ...
    .VPWR(VPWR),
    .X(_0550_));
 sky130_fd_sc_hd__clkbuf_2 _3313_ (.A(\u_interface.u_compute_core.u_av.v_extended[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand4_1 _3319_ (.A(_0441_),
    ...
    .VPWR(VPWR),
    .Y(_0557_));
 sky130_fd_sc_hd__a22o_1 _3320_ (.A1(_0436_),
 ...
 sky130_fd_sc_hd__nand2b_1 _3323_ (.A_N(_0559_),
    ...
    .VPWR(VPWR),
    .Y(_0561_));
 sky130_fd_sc_hd__xnor2_1 _3324_ (.A(_0556_),
    .B(_0561_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _3332_ (.A(_0568_),
    ...
    .VPWR(VPWR),
    .X(_0570_));
 sky130_fd_sc_hd__a21boi_1 _3333_ (.A1(_0505_),
    .A2(_0532_),
    .B1_N(_0531_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2b_1 _3342_ (.A(_0568_),
    ...
    .VPWR(VPWR),
    .X(_0579_));
 sky130_fd_sc_hd__o21ai_1 _3343_ (.A1(_0570_),
    .A2(_0571_),
    .B1(_0579_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_6 _3359_ (.A(\u_interface.u_compute_core.u_av.v_extended[10] ),
    ...
    .VPWR(VPWR),
    .X(_0596_));
 sky130_fd_sc_hd__nor2b_1 _3360_ (.A(\u_interface.u_compute_core.relu_data[0] ),
    .B_N(_0596_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _3363_ (.A(\u_interface.u_compute_core.u_av.v_extended[4] ),
    ...
    .VPWR(VPWR),
    .Y(_0600_));
 sky130_fd_sc_hd__a211o_1 _3364_ (.A1(_0468_),
    .A2(_1824_),
    .B1(_1827_),
    .C1(_0600_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3376_ (.A(_0611_),
    ...
    .VPWR(VPWR),
    .Y(_0613_));
 sky130_fd_sc_hd__xor2_1 _3377_ (.A(_0580_),
    .B(_0613_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3396_ (.A(_0625_),
    ...
    .VPWR(VPWR),
    .Y(_0632_));
 sky130_fd_sc_hd__and4_1 _3397_ (.A(\u_interface.u_compute_core.u_av.v_extended[6] ),
    .B(\u_interface.u_compute_core.u_av.v_extended[5] ),
    .C(\u_interface.u_compute_core.relu_data[3] ),
    .D(\u_interface.u_compute_core.relu_data[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0633_));
 sky130_fd_sc_hd__clkbuf_2 _3398_ (.A(\u_interface.u_compute_core.u_av.v_extended[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0634_));
 sky130_fd_sc_hd__a22oi_1 _3399_ (.A1(_0634_),
    .A2(_0458_),
    .B1(_1824_),
    .B2(_0551_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0635_));
 sky130_fd_sc_hd__nor4bb_1 _3400_ (.A(_0633_),
    .B(_0635_),
 ...
 sky130_fd_sc_hd__nand2_1 _3404_ (.A(_0639_),
    ...
    .VPWR(VPWR),
    .Y(_0640_));
 sky130_fd_sc_hd__nor2b_1 _3405_ (.A(\u_interface.u_compute_core.relu_data[1] ),
    .B_N(_0596_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _3406_ (.A(_0484_),
    ...
    .VPWR(VPWR),
    .Y(_0642_));
 sky130_fd_sc_hd__xnor2_1 _3407_ (.A(_0641_),
    .B(_0642_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _3414_ (.A1(_0557_),
    ...
    .VPWR(VPWR),
    .X(_0650_));
 sky130_fd_sc_hd__xnor2_1 _3415_ (.A(_0648_),
    .B(_0650_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ba_1 _3439_ (.A1(_0633_),
    ...
    .VPWR(VPWR),
    .X(_0674_));
 sky130_fd_sc_hd__or3b_1 _3440_ (.A(_0633_),
    .B(net64),
    .C_N(_0673_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _3441_ (.A_N(_0674_),
    ...
    .VPWR(VPWR),
    .X(_0676_));
 sky130_fd_sc_hd__xnor2_1 _3442_ (.A(_0670_),
    .B(_0676_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _3450_ (.A_N(\u_interface.u_compute_core.relu_data[2] ),
    ...
    .VPWR(VPWR),
    .X(_0685_));
 sky130_fd_sc_hd__nand2_1 _3451_ (.A(_0436_),
    .B(\u_interface.u_compute_core.relu_data[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0686_));
 sky130_fd_sc_hd__xnor2_1 _3452_ (.A(_0685_),
    .B(_0686_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3455_ (.A(_0437_),
    ...
    .VPWR(VPWR),
    .X(_0690_));
 sky130_fd_sc_hd__a31o_1 _3456_ (.A1(_0689_),
    .A2(_1829_),
    .A3(_0643_),
    .B1(_0690_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0691_));
 sky130_fd_sc_hd__xor2_1 _3457_ (.A(_0688_),
    .B(_0691_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0692_));
 sky130_fd_sc_hd__xnor2_1 _3458_ (.A(_0683_),
    .B(_0692_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3459_ (.A(_0644_),
    ...
    .VPWR(VPWR),
    .X(_0694_));
 sky130_fd_sc_hd__a21oi_1 _3460_ (.A1(_0638_),
    .A2(_0647_),
    .B1(_0694_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0695_));
 sky130_fd_sc_hd__xnor2_1 _3461_ (.A(_0693_),
    .B(_0695_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0696_));
 sky130_fd_sc_hd__xor2_1 _3462_ (.A(_0677_),
    .B(_0696_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _3463_ (.A(_0648_),
    ...
    .VPWR(VPWR),
    .X(_0698_));
 sky130_fd_sc_hd__o21a_1 _3464_ (.A1(_0632_),
    .A2(_0651_),
    .B1(_0698_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0699_));
 sky130_fd_sc_hd__xnor2_1 _3465_ (.A(_0697_),
    .B(_0699_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0700_));
 sky130_fd_sc_hd__xor2_1 _3466_ (.A(_0669_),
    .B(_0700_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _3470_ (.A_N(_0703_),
    ...
    .VPWR(VPWR),
    .X(_0705_));
 sky130_fd_sc_hd__nor2_1 _3471_ (.A(_0704_),
    .B(_0705_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _3472_ (.A1(_0621_),
    ...
    .VPWR(VPWR),
    .Y(_0707_));
 sky130_fd_sc_hd__xnor2_1 _3473_ (.A(_0706_),
    .B(_0707_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0708_));
 sky130_fd_sc_hd__xor2_1 _3474_ (.A(\u_interface.core_attn_out[6] ),
    .B(_0708_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3487_ (.A(_0717_),
    ...
    .VPWR(VPWR),
    .Y(_0721_));
 sky130_fd_sc_hd__xnor2_1 _3488_ (.A(_0672_),
    .B(_0721_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_1 _3491_ (.A1(_0511_),
    ...
    .VPWR(VPWR),
    .Y(_0725_));
 sky130_fd_sc_hd__nor2_1 _3492_ (.A(_0724_),
    .B(_0725_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0726_));
 sky130_fd_sc_hd__xnor2_1 _3493_ (.A(_0723_),
    .B(_0726_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3499_ (.A(_0437_),
    ...
    .VPWR(VPWR),
    .X(_0733_));
 sky130_fd_sc_hd__a31o_1 _3500_ (.A1(_0689_),
    .A2(_1832_),
    .A3(_0687_),
    .B1(_0733_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_2 _3501_ (.A(_0732_),
    ...
    .VPWR(VPWR),
    .X(_0735_));
 sky130_fd_sc_hd__xnor2_1 _3502_ (.A(_0727_),
    .B(_0735_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3503_ (.A(_0688_),
    ...
    .VPWR(VPWR),
    .X(_0737_));
 sky130_fd_sc_hd__a21oi_1 _3504_ (.A1(_0683_),
    .A2(_0692_),
    .B1(_0737_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0738_));
 sky130_fd_sc_hd__xnor2_1 _3505_ (.A(_0736_),
    .B(_0738_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0739_));
 sky130_fd_sc_hd__xor2_1 _3506_ (.A(_0722_),
    .B(_0739_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _3507_ (.A(_0693_),
    ...
    .VPWR(VPWR),
    .X(_0741_));
 sky130_fd_sc_hd__o21a_1 _3508_ (.A1(_0677_),
    .A2(_0696_),
    .B1(_0741_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0742_));
 sky130_fd_sc_hd__xnor2_1 _3509_ (.A(_0740_),
    .B(_0742_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0743_));
 sky130_fd_sc_hd__xnor2_1 _3510_ (.A(_0716_),
    .B(_0743_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _3511_ (.A_N(_0699_),
    ...
    .VPWR(VPWR),
    .X(_0745_));
 sky130_fd_sc_hd__a21oi_1 _3512_ (.A1(_0669_),
    .A2(_0700_),
    .B1(_0745_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0746_));
 sky130_fd_sc_hd__xor2_1 _3513_ (.A(_0744_),
    .B(_0746_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _3515_ (.A1(_0659_),
    ...
    .VPWR(VPWR),
    .X(_0749_));
 sky130_fd_sc_hd__a31o_1 _3516_ (.A1(_0621_),
    .A2(_0661_),
    .A3(_0706_),
    .B1(_0749_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0750_));
 sky130_fd_sc_hd__xor2_1 _3517_ (.A(_0747_),
    .B(_0750_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3521_ (.A(\u_interface.core_attn_out[6] ),
    ...
    .VPWR(VPWR),
    .X(_0755_));
 sky130_fd_sc_hd__a21o_1 _3522_ (.A1(_0709_),
    .A2(_0711_),
    .B1(_0755_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _3524_ (.A(_0715_),
    ...
    .VPWR(VPWR),
    .Y(_0758_));
 sky130_fd_sc_hd__o211a_1 _3525_ (.A1(\u_interface.core_attn_out[7] ),
    .A2(_0715_),
    .B1(_0434_),
    .C1(_0758_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0124_));
 sky130_fd_sc_hd__a21oi_1 _3526_ (.A1(_0753_),
    .A2(_0756_),
    .B1(_0752_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _3560_ (.A(_0744_),
    ...
    .VPWR(VPWR),
    .Y(_0793_));
 sky130_fd_sc_hd__a21oi_1 _3561_ (.A1(_0747_),
    .A2(_0750_),
    .B1(_0793_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0794_));
 sky130_fd_sc_hd__xnor2_1 _3562_ (.A(_0792_),
    .B(_0794_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0795_));
 sky130_fd_sc_hd__xor2_1 _3563_ (.A(\u_interface.core_attn_out[8] ),
    .B(_0795_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3587_ (.A(_0468_),
    ...
    .VPWR(VPWR),
    .X(_0819_));
 sky130_fd_sc_hd__a31o_1 _3588_ (.A1(_0689_),
    .A2(_1838_),
    .A3(_0778_),
    .B1(_0819_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_4 _3601_ (.A(_0830_),
    ...
    .VPWR(VPWR),
    .X(_0833_));
 sky130_fd_sc_hd__and2_1 _3602_ (.A(_0747_),
    .B(_0792_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _3629_ (.A_N(\u_interface.u_compute_core.relu_data[6] ),
    ...
    .VPWR(VPWR),
    .X(_0860_));
 sky130_fd_sc_hd__nand2_1 _3630_ (.A(_0436_),
 ...
 sky130_fd_sc_hd__a31o_1 _3634_ (.A1(_0689_),
    ...
    .VPWR(VPWR),
    .X(_0865_));
 sky130_fd_sc_hd__xor2_1 _3635_ (.A(_0863_),
    .B(_0865_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0866_));
 sky130_fd_sc_hd__xnor2_1 _3636_ (.A(_0858_),
    .B(_0866_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3639_ (.A(_0867_),
    ...
    .VPWR(VPWR),
    .Y(_0870_));
 sky130_fd_sc_hd__xor2_1 _3640_ (.A(_0853_),
    .B(_0870_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _3648_ (.A(_0834_),
    ...
    .VPWR(VPWR),
    .X(_0879_));
 sky130_fd_sc_hd__a311o_1 _3649_ (.A1(_0621_),
    .A2(_0661_),
    .A3(_0706_),
    .B1(_0749_),
    .C1(_0838_),
 ...
 sky130_fd_sc_hd__a31o_1 _3652_ (.A1(_0833_),
    ...
    .VPWR(VPWR),
    .X(_0883_));
 sky130_fd_sc_hd__xor2_1 _3653_ (.A(_0878_),
    .B(_0883_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0884_));
 sky130_fd_sc_hd__nand2_1 _3654_ (.A(\u_interface.core_attn_out[10] ),
    .B(_0884_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _3679_ (.A_N(\u_interface.u_compute_core.relu_data[7] ),
    ...
    .VPWR(VPWR),
    .X(_0909_));
 sky130_fd_sc_hd__nand2_1 _3680_ (.A(_0436_),
 ...
 sky130_fd_sc_hd__o21ai_1 _3699_ (.A1(_0875_),
    ...
    .VPWR(VPWR),
    .Y(_0929_));
 sky130_fd_sc_hd__a41o_1 _3700_ (.A1(_0833_),
    .A2(_0879_),
    .A3(_0880_),
    .A4(_0878_),
    .B1(_0929_),
    ...
    .VPWR(VPWR),
    .X(_0930_));
 sky130_fd_sc_hd__xor2_1 _3701_ (.A(_0927_),
    .B(_0930_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _3702_ (.A(\u_interface.core_attn_out[11] ),
    ...
    .VPWR(VPWR),
    .Y(_0932_));
 sky130_fd_sc_hd__nand2_1 _3703_ (.A(\u_interface.core_attn_out[11] ),
    .B(_0931_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _3710_ (.A1(_0885_),
    ...
    .VPWR(VPWR),
    .X(_0939_));
 sky130_fd_sc_hd__o211a_1 _3711_ (.A1(_0759_),
    .A2(_0889_),
    .B1(_0891_),
    .C1(_0939_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _3713_ (.A(_0920_),
    ...
    .VPWR(VPWR),
    .X(_0942_));
 sky130_fd_sc_hd__a21o_1 _3714_ (.A1(_0896_),
    .A2(_0923_),
    .B1(_0942_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _3733_ (.A(_0468_),
    ...
    .VPWR(VPWR),
    .X(_0962_));
 sky130_fd_sc_hd__a31o_1 _3734_ (.A1(_0689_),
    .A2(_1850_),
    .A3(_0911_),
    .B1(_0962_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0963_));
 sky130_fd_sc_hd__xor2_1 _3735_ (.A(_0961_),
    .B(_0963_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3743_ (.A(_0969_),
    ...
    .VPWR(VPWR),
    .Y(_0972_));
 sky130_fd_sc_hd__xnor2_1 _3744_ (.A(_0945_),
    .B(_0972_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0973_));
 sky130_fd_sc_hd__xor2_1 _3745_ (.A(_0943_),
    .B(_0973_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3769_ (.A(_0995_),
    ...
    .VPWR(VPWR),
    .Y(_0997_));
 sky130_fd_sc_hd__nor2b_1 _3770_ (.A(\u_interface.u_compute_core.relu_data[9] ),
    .B_N(\u_interface.u_compute_core.u_av.v_extended[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _3771_ (.A(_0436_),
    ...
    .VPWR(VPWR),
    .Y(_0999_));
 sky130_fd_sc_hd__xnor2_1 _3772_ (.A(_0998_),
    .B(_0999_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _3775_ (.A(_0468_),
    ...
    .VPWR(VPWR),
    .X(_1003_));
 sky130_fd_sc_hd__a31o_1 _3776_ (.A1(_0689_),
    .A2(_1853_),
    .A3(_0960_),
    .B1(_1003_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1004_));
 sky130_fd_sc_hd__xor2_1 _3777_ (.A(_1002_),
    .B(_1004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _3779_ (.A(_0961_),
    ...
    .VPWR(VPWR),
    .X(_1007_));
 sky130_fd_sc_hd__a21oi_1 _3780_ (.A1(_0956_),
    .A2(_0964_),
    .B1(_1007_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3781_ (.A(_1006_),
    ...
    .VPWR(VPWR),
    .Y(_1009_));
 sky130_fd_sc_hd__xor2_1 _3782_ (.A(_0992_),
    .B(_1009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3790_ (.A(_1014_),
    ...
    .VPWR(VPWR),
    .Y(_1018_));
 sky130_fd_sc_hd__and2_1 _3791_ (.A(_0927_),
    .B(_0974_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _3817_ (.A(_1040_),
    ...
    .VPWR(VPWR),
    .Y(_1044_));
 sky130_fd_sc_hd__xor2_1 _3818_ (.A(_0989_),
    .B(_1044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _3820_ (.A(_0436_),
    ...
    .VPWR(VPWR),
    .Y(_1047_));
 sky130_fd_sc_hd__xnor2_1 _3821_ (.A(_1046_),
    .B(_1047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _3822_ (.A(_0441_),
    ...
    .VPWR(VPWR),
    .Y(_1049_));
 sky130_fd_sc_hd__xnor2_1 _3823_ (.A(_1048_),
    .B(_1049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _3833_ (.A(_1002_),
    ...
    .VPWR(VPWR),
    .Y(_1060_));
 sky130_fd_sc_hd__a21boi_1 _3834_ (.A1(_0997_),
    .A2(_1005_),
    .B1_N(_1060_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _3835_ (.A(_1059_),
    ...
    .VPWR(VPWR),
    .X(_1062_));
 sky130_fd_sc_hd__xor2_1 _3836_ (.A(_1045_),
    .B(_1062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _3838_ (.A1(_0992_),
    ...
    .VPWR(VPWR),
    .X(_1065_));
 sky130_fd_sc_hd__xnor2_1 _3839_ (.A(_1063_),
    .B(_1065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _3842_ (.A1(_1036_),
    ...
    .VPWR(VPWR),
    .Y(_1069_));
 sky130_fd_sc_hd__or2_1 _3843_ (.A(_1068_),
    .B(_1069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _3902_ (.A1(_1124_),
    ...
    .VPWR(VPWR),
    .X(_1128_));
 sky130_fd_sc_hd__o221a_1 _3903_ (.A1(\u_interface.core_attn_out[15] ),
    .A2(_0715_),
    .B1(_1127_),
    .B2(_1128_),
    .C1(_0420_),
 ...
 sky130_fd_sc_hd__nor4_1 _3949_ (.A(_1028_),
    ...
    .VPWR(VPWR),
    .Y(_1174_));
 sky130_fd_sc_hd__or4b_1 _3950_ (.A(_0940_),
    .B(_0941_),
    .C(_0980_),
    .D_N(_1174_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4050_ (.A(_0421_),
    ...
    .VPWR(VPWR),
    .Y(_1273_));
 sky130_fd_sc_hd__o211a_1 _4051_ (.A1(\u_interface.core_attn_out[18] ),
    .A2(_0715_),
    .B1(_0434_),
    .C1(_1273_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4203_ (.A(_0421_),
    ...
    .VPWR(VPWR),
    .Y(_1423_));
 sky130_fd_sc_hd__o211a_1 _4204_ (.A1(\u_interface.core_attn_out[21] ),
    .A2(_0715_),
    .B1(_0434_),
    .C1(_1423_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _4244_ (.A(_1461_),
    ...
    .VPWR(VPWR),
    .Y(_1463_));
 sky130_fd_sc_hd__a211o_1 _4245_ (.A1(_1374_),
    .A2(_1375_),
    .B1(_1463_),
    .C1(_1415_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4306_ (.A(_0421_),
    ...
    .VPWR(VPWR),
    .Y(_1524_));
 sky130_fd_sc_hd__o211a_1 _4307_ (.A1(\u_interface.core_attn_out[23] ),
    .A2(_0715_),
    .B1(_0434_),
    .C1(_1524_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4399_ (.A(_0421_),
    ...
    .VPWR(VPWR),
    .Y(_1615_));
 sky130_fd_sc_hd__o211a_1 _4400_ (.A1(\u_interface.core_attn_out[25] ),
    .A2(_0715_),
    .B1(_0434_),
    .C1(_1615_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4445_ (.A(_0421_),
    ...
    .VPWR(VPWR),
    .Y(_1660_));
 sky130_fd_sc_hd__o211a_1 _4446_ (.A1(\u_interface.core_attn_out[26] ),
    .A2(_0715_),
    .B1(_1813_),
    .C1(_1660_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _4470_ (.A(_1682_),
    ...
    .VPWR(VPWR),
    .Y(_1684_));
 sky130_fd_sc_hd__a311o_1 _4471_ (.A1(_1651_),
    .A2(_1653_),
    .A3(_1661_),
    .B1(_1649_),
    .C1(_1684_),
 ...
 sky130_fd_sc_hd__o2111ai_1 _4473_ (.A1(_1653_),
    ...
    .VPWR(VPWR),
    .Y(_1687_));
 sky130_fd_sc_hd__and3_1 _4474_ (.A(\u_interface.core_attn_out[27] ),
    .B(_1685_),
    .C(_1687_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1688_));
 sky130_fd_sc_hd__a21oi_1 _4475_ (.A1(_1685_),
    .A2(_1687_),
    ...
    .VPWR(VPWR),
    .Y(_1689_));
 sky130_fd_sc_hd__or2_1 _4476_ (.A(_1688_),
    .B(_1689_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _4479_ (.A(_1690_),
    ...
    .VPWR(VPWR),
    .Y(_1693_));
 sky130_fd_sc_hd__nor2_1 _4480_ (.A(\u_interface.core_attn_out[27] ),
    .B(_0421_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211oi_1 _4481_ (.A1(_0715_),
    ...
    .VPWR(VPWR),
    .Y(_0144_));
 sky130_fd_sc_hd__or2_1 _4482_ (.A(_1656_),
    .B(_1690_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4483_ (.A(_1567_),
    ...
    .VPWR(VPWR),
    .Y(_1696_));
 sky130_fd_sc_hd__or3_1 _4484_ (.A(_1529_),
    .B(_1695_),
    .C(_1696_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _4486_ (.A(_1688_),
    ...
    .VPWR(VPWR),
    .Y(_1699_));
 sky130_fd_sc_hd__o221a_1 _4487_ (.A1(_1691_),
    .A2(_1689_),
    .B1(_1695_),
    .B2(_1698_),
    .C1(_1699_),
 ...
 sky130_fd_sc_hd__xnor2_2 _4505_ (.A(_1680_),
    ...
    .VPWR(VPWR),
    .Y(_1718_));
 sky130_fd_sc_hd__xnor2_4 _4506_ (.A(_1702_),
    .B(_1718_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4518_ (.A(_1720_),
    ...
    .VPWR(VPWR),
    .Y(_1729_));
 sky130_fd_sc_hd__a21oi_1 _4519_ (.A1(_1697_),
    .A2(_1700_),
    .B1(_1729_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _4523_ (.A(_1733_),
    ...
    .VPWR(VPWR),
    .Y(_1734_));
 sky130_fd_sc_hd__o31ai_1 _4524_ (.A1(_1724_),
    .A2(_1728_),
    .A3(_1730_),
    .B1(_1734_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4526_ (.A1(_1735_),
    ...
    .VPWR(VPWR),
    .X(_1737_));
 sky130_fd_sc_hd__o211a_1 _4527_ (.A1(\u_interface.core_attn_out[30] ),
    .A2(_0715_),
    .B1(_1813_),
    .C1(_1737_),
    .VGND(VGND),
