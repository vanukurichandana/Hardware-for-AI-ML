module top (clk,
 ...
 sky130_fd_sc_hd__nor2_1 _3109_ (.A(_2609_),
    ...
    .VPWR(VPWR),
    .Y(_0013_));
 sky130_fd_sc_hd__clkbuf_4 _3110_ (.A(\u_interface.u_compute_core.relu_data[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _3302_ (.A1(_2768_),
    ...
    .VPWR(VPWR),
    .Y(_2773_));
 sky130_fd_sc_hd__a22o_1 _3303_ (.A1(\u_interface.u_compute_core.mac_accum[5] ),
    .A2(_2756_),
    .B1(_2772_),
    .B2(_2773_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3331_ (.A(_2794_),
    ...
    .VPWR(VPWR),
    .Y(_2798_));
 sky130_fd_sc_hd__a22o_1 _3332_ (.A1(\u_interface.u_compute_core.mac_accum[9] ),
    .A2(_2756_),
    .B1(_2798_),
    .B2(_2741_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3345_ (.A(_2806_),
    ...
    .VPWR(VPWR),
    .Y(_2810_));
 sky130_fd_sc_hd__a22o_1 _3346_ (.A1(\u_interface.u_compute_core.mac_accum[11] ),
    .A2(_2805_),
    .B1(_2810_),
    .B2(_2741_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3359_ (.A(_2818_),
    ...
    .VPWR(VPWR),
    .Y(_2822_));
 sky130_fd_sc_hd__a22o_1 _3360_ (.A1(\u_interface.u_compute_core.mac_accum[13] ),
    .A2(_2805_),
    .B1(_2822_),
    .B2(_2741_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _3376_ (.A(_2830_),
    ...
    .VPWR(VPWR),
    .Y(_2837_));
 sky130_fd_sc_hd__a22o_1 _3377_ (.A1(\u_interface.u_compute_core.mac_accum[15] ),
    .A2(_2805_),
    .B1(_2837_),
    .B2(_2741_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31a_1 _3415_ (.A1(_2860_),
    ...
    .VPWR(VPWR),
    .X(_2870_));
 sky130_fd_sc_hd__a22o_1 _3416_ (.A1(\u_interface.u_compute_core.mac_accum[21] ),
    .A2(_2805_),
    .B1(_2869_),
    .B2(_2870_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _3428_ (.A1(_2878_),
    ...
    .VPWR(VPWR),
    .X(_2881_));
 sky130_fd_sc_hd__a22o_1 _3429_ (.A1(\u_interface.u_compute_core.mac_accum[23] ),
    .A2(_2805_),
    .B1(_2880_),
    .B2(_2881_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31a_1 _3452_ (.A1(_2900_),
    ...
    .VPWR(VPWR),
    .X(_2902_));
 sky130_fd_sc_hd__a22o_1 _3453_ (.A1(\u_interface.u_compute_core.mac_accum[26] ),
    .A2(_2805_),
    .B1(_2901_),
    .B2(_2902_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _3457_ (.A1(_2903_),
    ...
    .VPWR(VPWR),
    .Y(_2906_));
 sky130_fd_sc_hd__a22o_1 _3458_ (.A1(\u_interface.u_compute_core.mac_accum[27] ),
    .A2(_2805_),
    .B1(_2905_),
    .B2(_2906_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _3477_ (.A(_2754_),
    ...
    .VPWR(VPWR),
    .X(_2923_));
 sky130_fd_sc_hd__o211a_1 _3478_ (.A1(\u_interface.u_compute_core.mac_accum[30] ),
    .A2(net27),
    .B1(_2923_),
    .C1(net61),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _3482_ (.A1(_2924_),
    ...
    .VPWR(VPWR),
    .Y(_2927_));
 sky130_fd_sc_hd__a22o_1 _3483_ (.A1(\u_interface.u_compute_core.mac_accum[31] ),
    .A2(_2805_),
    .B1(_2926_),
    .B2(_2927_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _3571_ (.A(_3008_),
    ...
    .VPWR(VPWR),
    .X(_3010_));
 sky130_fd_sc_hd__a22o_1 _3572_ (.A1(\u_interface.u_compute_core.u_mac.product_reg[5] ),
    .A2(_2805_),
    .B1(_3010_),
    .B2(_2741_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or3_1 _3689_ (.A(_2753_),
    ...
    .VPWR(VPWR),
    .X(_0286_));
 sky130_fd_sc_hd__a21bo_1 _3690_ (.A1(\u_interface.u_compute_core.u_mac.product_reg[8] ),
    .A2(_2756_),
    .B1_N(_0286_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _3884_ (.A1(_0452_),
    ...
    .VPWR(VPWR),
    .Y(_0475_));
 sky130_fd_sc_hd__and2_1 _3885_ (.A(\u_interface.u_compute_core.u_mac.product_reg[14] ),
    .B(_2745_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _3960_ (.A1(_0509_),
    ...
    .VPWR(VPWR),
    .X(_0545_));
 sky130_fd_sc_hd__a22o_1 _3961_ (.A1(_2601_),
    .A2(_0494_),
    .B1(_0496_),
    .B2(_2598_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _3997_ (.A1_N(_2598_),
    ...
    .VPWR(VPWR),
    .X(_0581_));
 sky130_fd_sc_hd__nor3_1 _3998_ (.A(_0548_),
    .B(_0579_),
    .C(_0581_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4031_ (.A(_2598_),
    ...
    .VPWR(VPWR),
    .Y(_0614_));
 sky130_fd_sc_hd__and4_1 _4032_ (.A(\u_interface.u_compute_core.relu_data[6] ),
    .B(\u_interface.u_compute_core.relu_data[5] ),
    .C(_0503_),
    .D(net19),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2b_1 _4039_ (.A(_0620_),
    ...
    .VPWR(VPWR),
    .X(_0622_));
 sky130_fd_sc_hd__xnor2_1 _4040_ (.A(net65),
    .B(_0622_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _4054_ (.A(_0623_),
    ...
    .VPWR(VPWR),
    .Y(_0637_));
 sky130_fd_sc_hd__xor2_1 _4055_ (.A(_0600_),
    .B(_0637_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0638_));
 sky130_fd_sc_hd__xnor2_1 _4056_ (.A(_0613_),
    .B(_0638_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand4_1 _4085_ (.A(_2604_),
    ...
    .VPWR(VPWR),
    .Y(_0667_));
 sky130_fd_sc_hd__a22o_1 _4086_ (.A1(\u_interface.u_compute_core.relu_data[6] ),
    .A2(_0498_),
    .B1(_0488_),
 ...
 sky130_fd_sc_hd__xnor2_1 _4095_ (.A(_0665_),
    ...
    .VPWR(VPWR),
    .Y(_0677_));
 sky130_fd_sc_hd__xor2_1 _4096_ (.A(_0655_),
    .B(_0677_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0678_));
 sky130_fd_sc_hd__xor2_1 _4097_ (.A(_0654_),
    .B(_0678_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _4099_ (.A1(_0612_),
    ...
    .VPWR(VPWR),
    .X(_0681_));
 sky130_fd_sc_hd__xor2_1 _4100_ (.A(_0679_),
    .B(_0681_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0682_));
 sky130_fd_sc_hd__xor2_1 _4101_ (.A(_0651_),
    .B(_0682_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0683_));
 sky130_fd_sc_hd__xor2_1 _4102_ (.A(_0650_),
    .B(_0683_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4132_ (.A(\u_interface.u_compute_core.relu_data[4] ),
    ...
    .VPWR(VPWR),
    .Y(_0713_));
 sky130_fd_sc_hd__nand4_1 _4133_ (.A(\u_interface.u_compute_core.relu_data[6] ),
    .B(\u_interface.u_compute_core.relu_data[5] ),
    .C(net20),
    .D(_0586_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _4164_ (.A(_0740_),
    ...
    .VPWR(VPWR),
    .Y(_0744_));
 sky130_fd_sc_hd__and3_1 _4165_ (.A(_2619_),
    .B(_0494_),
    .C(_0744_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4178_ (.A(\u_interface.u_compute_core.relu_data[4] ),
    ...
    .VPWR(VPWR),
    .Y(_0758_));
 sky130_fd_sc_hd__nand4_1 _4179_ (.A(\u_interface.u_compute_core.relu_data[6] ),
    .B(\u_interface.u_compute_core.relu_data[5] ),
    .C(_0586_),
    .D(_0556_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4194_ (.A1(_0771_),
    ...
    .VPWR(VPWR),
    .Y(_0774_));
 sky130_fd_sc_hd__or3_1 _4195_ (.A(_0747_),
    .B(_0773_),
    .C(_0774_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _4201_ (.A_N(_0737_),
    ...
    .VPWR(VPWR),
    .X(_0781_));
 sky130_fd_sc_hd__dlymetal6s2s_1 _4202_ (.A(_0781_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or3_1 _4204_ (.A(_0736_),
    ...
    .VPWR(VPWR),
    .X(_0784_));
 sky130_fd_sc_hd__o21ai_1 _4205_ (.A1(_0782_),
    .A2(_0783_),
    .B1(_0736_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4218_ (.A(_0612_),
    ...
    .VPWR(VPWR),
    .Y(_0797_));
 sky130_fd_sc_hd__and4_1 _4219_ (.A(_2615_),
    .B(_2611_),
    .C(_0499_),
    .D(_0489_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _4221_ (.A_N(_0798_),
    ...
    .VPWR(VPWR),
    .X(_0800_));
 sky130_fd_sc_hd__xnor2_1 _4222_ (.A(_0797_),
    .B(_0800_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _4238_ (.A1(_0612_),
    ...
    .VPWR(VPWR),
    .X(_0817_));
 sky130_fd_sc_hd__and2_1 _4239_ (.A(_2598_),
    .B(_0656_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _4241_ (.A1(_2604_),
    ...
    .VPWR(VPWR),
    .X(_0820_));
 sky130_fd_sc_hd__nand4_1 _4242_ (.A(_2604_),
    .B(_2601_),
    .C(_0557_),
    .D(_0595_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _4243_ (.A(_0818_),
    ...
    .VPWR(VPWR),
    .Y(_0822_));
 sky130_fd_sc_hd__a21o_1 _4244_ (.A1(_0820_),
    .A2(_0821_),
    .B1(_0818_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _4247_ (.A(_0815_),
    ...
    .VPWR(VPWR),
    .Y(_0826_));
 sky130_fd_sc_hd__a21o_1 _4248_ (.A1(_0824_),
    .A2(_0825_),
    .B1(_0815_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0827_));
 sky130_fd_sc_hd__nand3_1 _4249_ (.A(_0745_),
    .B(_0826_),
    .C(_0827_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4250_ (.A1(_0826_),
    ...
    .VPWR(VPWR),
    .X(_0829_));
 sky130_fd_sc_hd__and3_1 _4251_ (.A(_0814_),
    .B(_0828_),
    .C(_0829_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4252_ (.A1(_0828_),
    ...
    .VPWR(VPWR),
    .Y(_0831_));
 sky130_fd_sc_hd__or3_1 _4253_ (.A(_0767_),
    .B(_0830_),
    .C(_0831_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_4 _4256_ (.A(_0812_),
    ...
    .VPWR(VPWR),
    .X(_0835_));
 sky130_fd_sc_hd__a21o_1 _4257_ (.A1(_0832_),
    .A2(_0833_),
    .B1(_0835_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0836_));
 sky130_fd_sc_hd__and3_1 _4258_ (.A(_0808_),
    .B(_0834_),
    .C(_0836_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4259_ (.A1(_0834_),
    ...
    .VPWR(VPWR),
    .Y(_0838_));
 sky130_fd_sc_hd__or3_1 _4260_ (.A(_0807_),
    .B(_0837_),
    .C(_0838_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _4261_ (.A1(_0837_),
    ...
    .VPWR(VPWR),
    .Y(_0840_));
 sky130_fd_sc_hd__and3b_1 _4262_ (.A_N(_0775_),
    .B(_0839_),
    .C(_0840_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor3b_2 _4264_ (.A(_0841_),
    ...
    .VPWR(VPWR),
    .Y(_0843_));
 sky130_fd_sc_hd__o21ba_1 _4265_ (.A1(_0841_),
    .A2(_0842_),
    .B1_N(_0773_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211ai_2 _4267_ (.A1(_0843_),
    ...
    .VPWR(VPWR),
    .Y(_0846_));
 sky130_fd_sc_hd__nand3_1 _4268_ (.A(_0796_),
    .B(_0845_),
    .C(_0846_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4269_ (.A1(_0845_),
    ...
    .VPWR(VPWR),
    .X(_0848_));
 sky130_fd_sc_hd__nor3_1 _4270_ (.A(_0736_),
    .B(_0782_),
    .C(_0783_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _4274_ (.A1(_0850_),
    ...
    .VPWR(VPWR),
    .X(_0853_));
 sky130_fd_sc_hd__o31ai_1 _4275_ (.A1(_0852_),
    .A2(_0850_),
    .A3(_0851_),
    .B1(_0521_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _4282_ (.A_N(_0858_),
    ...
    .VPWR(VPWR),
    .X(_0860_));
 sky130_fd_sc_hd__xnor2_1 _4283_ (.A(_0857_),
    .B(_0860_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _4315_ (.A1(_0890_),
    ...
    .VPWR(VPWR),
    .X(_0893_));
 sky130_fd_sc_hd__nand3_1 _4316_ (.A(_0870_),
    .B(_0892_),
    .C(_0893_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4331_ (.A1(_0905_),
    ...
    .VPWR(VPWR),
    .X(_0909_));
 sky130_fd_sc_hd__a211o_1 _4332_ (.A1(_0847_),
    .A2(_0848_),
    .B1(_0782_),
    .C1(_0849_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22oi_2 _4352_ (.A1(_2625_),
    ...
    .VPWR(VPWR),
    .Y(_0929_));
 sky130_fd_sc_hd__or3_1 _4353_ (.A(_0926_),
    .B(_0928_),
    .C(_0929_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _4356_ (.A(_0930_),
    ...
    .VPWR(VPWR),
    .X(_0933_));
 sky130_fd_sc_hd__a21o_1 _4357_ (.A1(_0930_),
    .A2(_0931_),
    .B1(_0932_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand4_1 _4369_ (.A(_2598_),
    ...
    .VPWR(VPWR),
    .Y(_0946_));
 sky130_fd_sc_hd__clkbuf_4 _4370_ (.A(_0946_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand3_1 _4377_ (.A(_0942_),
    ...
    .VPWR(VPWR),
    .Y(_0954_));
 sky130_fd_sc_hd__a21o_1 _4378_ (.A1(_0952_),
    .A2(_0953_),
    .B1(_0942_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0955_));
 sky130_fd_sc_hd__and3_1 _4379_ (.A(_0941_),
    .B(_0954_),
    .C(_0955_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0956_));
 sky130_fd_sc_hd__a21oi_1 _4380_ (.A1(_0954_),
    .A2(_0955_),
    .B1(_0941_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4384_ (.A1(_0958_),
    ...
    .VPWR(VPWR),
    .Y(_0961_));
 sky130_fd_sc_hd__or3_2 _4385_ (.A(_0940_),
    .B(_0960_),
    .C(_0961_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _4386_ (.A1(_0960_),
    ...
    .VPWR(VPWR),
    .Y(_0963_));
 sky130_fd_sc_hd__and3_2 _4387_ (.A(_0939_),
    .B(_0962_),
    .C(_0963_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4388_ (.A1(_0962_),
    ...
    .VPWR(VPWR),
    .Y(_0965_));
 sky130_fd_sc_hd__or3_1 _4389_ (.A(_0894_),
    .B(_0964_),
    .C(_0965_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3b_1 _4391_ (.A_N(_0892_),
    ...
    .VPWR(VPWR),
    .Y(_0968_));
 sky130_fd_sc_hd__a21bo_1 _4392_ (.A1(_0966_),
    .A2(_0967_),
    .B1_N(_0892_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0969_));
 sky130_fd_sc_hd__o211a_1 _4393_ (.A1(_0899_),
    .A2(_0919_),
    .B1(_0968_),
    .C1(_0969_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_2 _4394_ (.A1(_0968_),
    ...
    .VPWR(VPWR),
    .Y(_0971_));
 sky130_fd_sc_hd__or3_1 _4395_ (.A(_0918_),
    .B(_0970_),
    .C(_0971_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4398_ (.A1(_0972_),
    ...
    .VPWR(VPWR),
    .Y(_0975_));
 sky130_fd_sc_hd__and3_1 _4399_ (.A(_0974_),
    .B(_0972_),
    .C(_0973_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4417_ (.A(\u_interface.u_compute_core.relu_data[10] ),
    ...
    .VPWR(VPWR),
    .Y(_0993_));
 sky130_fd_sc_hd__and4_1 _4418_ (.A(\u_interface.u_compute_core.relu_data[12] ),
    .B(_0927_),
    .C(net19),
    .D(net20),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22oi_2 _4419_ (.A1(\u_interface.u_compute_core.relu_data[12] ),
    ...
    .VPWR(VPWR),
    .Y(_0995_));
 sky130_fd_sc_hd__or3_1 _4420_ (.A(_0993_),
    .B(_0994_),
    .C(_0995_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4428_ (.A(_0986_),
    ...
    .VPWR(VPWR),
    .Y(_1004_));
 sky130_fd_sc_hd__and2_1 _4429_ (.A(_1003_),
    .B(_1004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _4448_ (.A1(_1021_),
    ...
    .VPWR(VPWR),
    .X(_1024_));
 sky130_fd_sc_hd__and3_1 _4449_ (.A(_1007_),
    .B(_1023_),
    .C(_1024_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _4460_ (.A_N(_1034_),
    ...
    .VPWR(VPWR),
    .X(_1036_));
 sky130_fd_sc_hd__or3_1 _4461_ (.A(_0911_),
    .B(_0975_),
    .C(_0976_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ba_1 _4462_ (.A1(_0908_),
    ...
    .VPWR(VPWR),
    .X(_1038_));
 sky130_fd_sc_hd__nand2_1 _4463_ (.A(_1037_),
    .B(_1038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _4469_ (.A1(_1042_),
    ...
    .VPWR(VPWR),
    .X(_1044_));
 sky130_fd_sc_hd__or3b_1 _4470_ (.A(_1025_),
    .B(_1026_),
    .C_N(_1006_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _4472_ (.A(\u_interface.u_compute_core.relu_data[15] ),
    ...
    .VPWR(VPWR),
    .X(_1047_));
 sky130_fd_sc_hd__a22o_1 _4473_ (.A1(\u_interface.u_compute_core.relu_data[15] ),
    .A2(_0492_),
    .B1(_0503_),
 ...
 sky130_fd_sc_hd__a22oi_2 _4485_ (.A1(_2625_),
    ...
    .VPWR(VPWR),
    .Y(_1060_));
 sky130_fd_sc_hd__or3_1 _4486_ (.A(_1058_),
    .B(_1059_),
    .C(_1060_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2b_1 _4491_ (.A(_1064_),
    ...
    .VPWR(VPWR),
    .Y(_1066_));
 sky130_fd_sc_hd__xnor2_1 _4492_ (.A(_1057_),
    .B(_1066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1067_));
 sky130_fd_sc_hd__or2_1 _4493_ (.A(_1053_),
    .B(_1067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4501_ (.A(_1012_),
    ...
    .VPWR(VPWR),
    .Y(_1076_));
 sky130_fd_sc_hd__a21o_1 _4502_ (.A1(_0992_),
    .A2(_1000_),
    .B1(_0999_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4521_ (.A1(_1093_),
    ...
    .VPWR(VPWR),
    .X(_1096_));
 sky130_fd_sc_hd__and3_1 _4522_ (.A(_1073_),
    .B(_1095_),
    .C(_1096_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4523_ (.A1(_1095_),
    ...
    .VPWR(VPWR),
    .Y(_1098_));
 sky130_fd_sc_hd__or3_2 _4524_ (.A(_1045_),
    .B(_1097_),
    .C(_1098_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _4529_ (.A1(_0962_),
    ...
    .VPWR(VPWR),
    .Y(_1104_));
 sky130_fd_sc_hd__and3_1 _4530_ (.A(_1101_),
    .B(_1102_),
    .C(_1104_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _4541_ (.A1(_0485_),
    ...
    .VPWR(VPWR),
    .X(_0121_));
 sky130_fd_sc_hd__o21bai_1 _4542_ (.A1(_0918_),
    .A2(_1106_),
    .B1_N(_1105_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_2 _4560_ (.A(_1071_),
    ...
    .VPWR(VPWR),
    .Y(_1134_));
 sky130_fd_sc_hd__a21o_1 _4561_ (.A1(_1132_),
    .A2(_1133_),
    .B1(_1071_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1135_));
 sky130_fd_sc_hd__nand3_1 _4562_ (.A(_1117_),
    .B(_1134_),
    .C(_1135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1136_));
 sky130_fd_sc_hd__a21o_1 _4563_ (.A1(_1134_),
    .A2(_1135_),
    .B1(_1117_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _4567_ (.A_N(_1139_),
    ...
    .VPWR(VPWR),
    .X(_1141_));
 sky130_fd_sc_hd__mux2_1 _4568_ (.A0(_0988_),
    .A1(_2607_),
    .S(_1141_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4571_ (.A(_2619_),
    ...
    .VPWR(VPWR),
    .Y(_1145_));
 sky130_fd_sc_hd__and4_1 _4572_ (.A(\u_interface.u_compute_core.relu_data[12] ),
    .B(_0927_),
    .C(net21),
    .D(_0556_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22oi_2 _4573_ (.A1(_2625_),
    ...
    .VPWR(VPWR),
    .Y(_1147_));
 sky130_fd_sc_hd__or3_1 _4574_ (.A(_1145_),
    .B(_1146_),
    .C(_1147_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _4575_ (.A1(_1146_),
    ...
    .VPWR(VPWR),
    .Y(_1149_));
 sky130_fd_sc_hd__and3_1 _4576_ (.A(_1144_),
    .B(_1148_),
    .C(_1149_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _4578_ (.A_N(_1150_),
    ...
    .VPWR(VPWR),
    .X(_1152_));
 sky130_fd_sc_hd__xnor2_1 _4579_ (.A(_1143_),
    .B(_1152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _4582_ (.A(\u_interface.u_compute_core.relu_data[15] ),
    ...
    .VPWR(VPWR),
    .X(_1156_));
 sky130_fd_sc_hd__a22o_1 _4583_ (.A1(\u_interface.u_compute_core.relu_data[15] ),
    .A2(net14),
    .B1(net19),
    .B2(\u_interface.u_compute_core.relu_data[14] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _4587_ (.A(_1051_),
    ...
    .VPWR(VPWR),
    .Y(_1161_));
 sky130_fd_sc_hd__nor2_1 _4588_ (.A(_1153_),
    .B(_1161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1162_));
 sky130_fd_sc_hd__and2_1 _4589_ (.A(_1153_),
    .B(_1161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1163_));
 sky130_fd_sc_hd__nor3_1 _4590_ (.A(_1068_),
    .B(_1162_),
    .C(_1163_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _4591_ (.A1(_1162_),
    ...
    .VPWR(VPWR),
    .X(_1165_));
 sky130_fd_sc_hd__or2_1 _4592_ (.A(_1164_),
    .B(_1165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1166_));
 sky130_fd_sc_hd__or2_1 _4593_ (.A(_1138_),
    .B(_1166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4594_ (.A(_1138_),
    ...
    .VPWR(VPWR),
    .Y(_1168_));
 sky130_fd_sc_hd__and2_1 _4595_ (.A(_1167_),
    .B(_1168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1169_));
 sky130_fd_sc_hd__and3_1 _4596_ (.A(_1136_),
    .B(_1137_),
    .C(_1169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1170_));
 sky130_fd_sc_hd__a21oi_1 _4597_ (.A1(_1136_),
    .A2(_1137_),
    .B1(_1169_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor3b_2 _4598_ (.A(_1170_),
    ...
    .VPWR(VPWR),
    .Y(_1172_));
 sky130_fd_sc_hd__o21ba_1 _4599_ (.A1(_1170_),
    .A2(_1171_),
    .B1_N(_1097_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a211oi_2 _4600_ (.A1(_1093_),
    ...
    .VPWR(VPWR),
    .Y(_1174_));
 sky130_fd_sc_hd__o211a_1 _4601_ (.A1(_1172_),
    .A2(_1173_),
    .B1(_1093_),
    .C1(_1095_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_2 _4602_ (.A1(_1099_),
    ...
    .VPWR(VPWR),
    .Y(_1176_));
 sky130_fd_sc_hd__o211a_1 _4603_ (.A1(_1174_),
    .A2(_1175_),
    .B1(_1099_),
    .C1(_1101_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1177_));
 sky130_fd_sc_hd__or3_1 _4604_ (.A(_0917_),
    .B(_1176_),
    .C(_1177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1178_));
 sky130_fd_sc_hd__o21ai_1 _4605_ (.A1(_1176_),
    .A2(_1177_),
    .B1(_0918_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1179_));
 sky130_fd_sc_hd__and3_1 _4606_ (.A(_1116_),
    .B(_1178_),
    .C(_1179_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4607_ (.A1(_1178_),
    ...
    .VPWR(VPWR),
    .Y(_1181_));
 sky130_fd_sc_hd__or2_1 _4608_ (.A(_1180_),
    .B(_1181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _4610_ (.A(_1035_),
    ...
    .VPWR(VPWR),
    .Y(_1184_));
 sky130_fd_sc_hd__a311o_2 _4611_ (.A1(_1037_),
    .A2(_1038_),
    .A3(_1183_),
    .B1(_1184_),
    .C1(_1111_),
 ...
 sky130_fd_sc_hd__nand2_1 _4644_ (.A(\u_interface.u_compute_core.relu_data[10] ),
    ...
    .VPWR(VPWR),
    .Y(_1217_));
 sky130_fd_sc_hd__and4_1 _4645_ (.A(\u_interface.u_compute_core.relu_data[12] ),
    .B(_0927_),
    .C(net22),
    .D(net23),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _4646_ (.A1(\u_interface.u_compute_core.relu_data[12] ),
    ...
    .VPWR(VPWR),
    .X(_1219_));
 sky130_fd_sc_hd__or3b_1 _4647_ (.A(_1217_),
    .B(_1218_),
    .C_N(_1219_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _4651_ (.A1(_1146_),
    ...
    .VPWR(VPWR),
    .X(_1224_));
 sky130_fd_sc_hd__a211o_1 _4652_ (.A1(_1220_),
    .A2(_1223_),
    .B1(_1146_),
    .C1(_1216_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _4653_ (.A_N(_1224_),
    ...
    .VPWR(VPWR),
    .X(_1226_));
 sky130_fd_sc_hd__xnor2_1 _4654_ (.A(_1143_),
    .B(_1226_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4657_ (.A(_2628_),
    ...
    .VPWR(VPWR),
    .Y(_1230_));
 sky130_fd_sc_hd__and4_1 _4658_ (.A(\u_interface.u_compute_core.relu_data[15] ),
    .B(\u_interface.u_compute_core.relu_data[14] ),
    .C(net19),
    .D(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1231_));
 sky130_fd_sc_hd__a22o_1 _4659_ (.A1(\u_interface.u_compute_core.relu_data[15] ),
    .A2(net19),
    .B1(_0488_),
    .B2(\u_interface.u_compute_core.relu_data[14] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _4663_ (.A(_1228_),
    ...
    .VPWR(VPWR),
    .Y(_1236_));
 sky130_fd_sc_hd__or2_1 _4664_ (.A(_1227_),
    .B(_1236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4665_ (.A(_1227_),
    ...
    .VPWR(VPWR),
    .Y(_1238_));
 sky130_fd_sc_hd__o211a_1 _4666_ (.A1(_1215_),
    .A2(_1162_),
    .B1(_1237_),
    .C1(_1238_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1239_));
 sky130_fd_sc_hd__a211oi_1 _4667_ (.A1(_1237_),
    .A2(_1238_),
    .B1(_1215_),
    .C1(_1162_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1240_));
 sky130_fd_sc_hd__nor2_1 _4668_ (.A(_1239_),
    .B(_1240_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1241_));
 sky130_fd_sc_hd__xnor2_1 _4669_ (.A(_1214_),
    .B(_1241_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1242_));
 sky130_fd_sc_hd__xor2_1 _4670_ (.A(_1167_),
    .B(_1242_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _4672_ (.A1(_1207_),
    ...
    .VPWR(VPWR),
    .X(_1245_));
 sky130_fd_sc_hd__and3_1 _4673_ (.A(_1170_),
    .B(_1244_),
    .C(_1245_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4674_ (.A1(_1244_),
    ...
    .VPWR(VPWR),
    .Y(_1247_));
 sky130_fd_sc_hd__a211o_1 _4675_ (.A1(_1134_),
    .A2(_1136_),
    .B1(_1246_),
    .C1(_1247_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211ai_2 _4676_ (.A1(_1246_),
    ...
    .VPWR(VPWR),
    .Y(_1249_));
 sky130_fd_sc_hd__o211a_1 _4677_ (.A1(_1172_),
    .A2(_1174_),
    .B1(_1248_),
    .C1(_1249_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_2 _4678_ (.A1(_1248_),
    ...
    .VPWR(VPWR),
    .Y(_1251_));
 sky130_fd_sc_hd__or3_1 _4679_ (.A(_0917_),
    .B(_1250_),
    .C(_1251_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4682_ (.A1(_1252_),
    ...
    .VPWR(VPWR),
    .Y(_1255_));
 sky130_fd_sc_hd__and3_1 _4683_ (.A(_1254_),
    .B(_1252_),
    .C(_1253_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _4692_ (.A(_1191_),
    ...
    .VPWR(VPWR),
    .Y(_1264_));
 sky130_fd_sc_hd__a21o_1 _4693_ (.A1(_1143_),
    .A2(_1225_),
    .B1(_1224_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4695_ (.A1(_1193_),
    ...
    .VPWR(VPWR),
    .X(_1267_));
 sky130_fd_sc_hd__and3_1 _4696_ (.A(_1264_),
    .B(_1266_),
    .C(_1267_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21boi_1 _4698_ (.A1(_1189_),
    ...
    .VPWR(VPWR),
    .Y(_1270_));
 sky130_fd_sc_hd__or3_1 _4699_ (.A(_1268_),
    .B(_1269_),
    .C(_1270_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _4701_ (.A(_0835_),
    ...
    .VPWR(VPWR),
    .Y(_1273_));
 sky130_fd_sc_hd__a21o_1 _4702_ (.A1(_1271_),
    .A2(_1272_),
    .B1(_0835_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_2 _4703_ (.A(_1239_),
    ...
    .VPWR(VPWR),
    .Y(_1275_));
 sky130_fd_sc_hd__a21o_1 _4704_ (.A1(_1273_),
    .A2(_1274_),
    .B1(_1239_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_2 _4705_ (.A(_1263_),
    ...
    .VPWR(VPWR),
    .Y(_1277_));
 sky130_fd_sc_hd__a21o_1 _4706_ (.A1(_1275_),
    .A2(_1276_),
    .B1(_1263_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2b_1 _4715_ (.A(_1285_),
    ...
    .VPWR(VPWR),
    .Y(_1287_));
 sky130_fd_sc_hd__xnor2_1 _4716_ (.A(_1143_),
    .B(_1287_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _4727_ (.A(_1289_),
    ...
    .VPWR(VPWR),
    .Y(_1299_));
 sky130_fd_sc_hd__nor2_1 _4728_ (.A(_1288_),
    .B(_1299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _4741_ (.A1(_1302_),
    ...
    .VPWR(VPWR),
    .X(_1313_));
 sky130_fd_sc_hd__or3_1 _4742_ (.A(_1312_),
    .B(_1302_),
    .C(_1303_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _4745_ (.A(_1314_),
    ...
    .VPWR(VPWR),
    .Y(_1317_));
 sky130_fd_sc_hd__a2bb2o_1 _4746_ (.A1_N(_1317_),
    .A2_N(_1313_),
    .B1(_1214_),
    .B2(_1241_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1318_));
 sky130_fd_sc_hd__and4_1 _4747_ (.A(_1277_),
    .B(_1278_),
    .C(_1316_),
    .D(_1318_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_2 _4758_ (.A(_1328_),
    ...
    .VPWR(VPWR),
    .X(_1330_));
 sky130_fd_sc_hd__or4_1 _4759_ (.A(_1180_),
    .B(_1181_),
    .C(_1255_),
    .D(_1256_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4760_ (.A1(_1252_),
    ...
    .VPWR(VPWR),
    .X(_1332_));
 sky130_fd_sc_hd__a21o_1 _4761_ (.A1(_1180_),
    .A2(_1332_),
    .B1(_1256_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4775_ (.A1(_1193_),
    ...
    .VPWR(VPWR),
    .Y(_1346_));
 sky130_fd_sc_hd__or3_1 _4776_ (.A(_1343_),
    .B(_1345_),
    .C(_1346_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _4779_ (.A(_1347_),
    ...
    .VPWR(VPWR),
    .Y(_1350_));
 sky130_fd_sc_hd__a21o_1 _4780_ (.A1(_1347_),
    .A2(_1348_),
    .B1(_1349_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_2 _4785_ (.A(_1342_),
    ...
    .VPWR(VPWR),
    .Y(_1356_));
 sky130_fd_sc_hd__a21o_1 _4786_ (.A1(_1354_),
    .A2(_1355_),
    .B1(_1342_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _4802_ (.A(_1371_),
    ...
    .VPWR(VPWR),
    .Y(_1373_));
 sky130_fd_sc_hd__xor2_1 _4803_ (.A(_1143_),
    .B(_1373_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _4804_ (.A(\u_interface.u_compute_core.relu_data[13] ),
    ...
    .VPWR(VPWR),
    .Y(_1375_));
 sky130_fd_sc_hd__nand4_1 _4805_ (.A(_2634_),
    .B(_2631_),
    .C(_0534_),
    .D(_0625_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _4809_ (.A1(_1291_),
    ...
    .VPWR(VPWR),
    .Y(_1380_));
 sky130_fd_sc_hd__and3_1 _4810_ (.A(_1378_),
    .B(_1379_),
    .C(_1380_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4811_ (.A1(_1378_),
    ...
    .VPWR(VPWR),
    .Y(_1382_));
 sky130_fd_sc_hd__or3_1 _4812_ (.A(_1296_),
    .B(_1381_),
    .C(_1382_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4815_ (.A1(_1383_),
    ...
    .VPWR(VPWR),
    .X(_1386_));
 sky130_fd_sc_hd__and2_1 _4816_ (.A(_1385_),
    .B(_1386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _4817_ (.A(_1310_),
    ...
    .VPWR(VPWR),
    .X(_1388_));
 sky130_fd_sc_hd__xnor2_1 _4818_ (.A(_1368_),
    .B(_1388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211oi_2 _4824_ (.A1(_1392_),
    ...
    .VPWR(VPWR),
    .Y(_1395_));
 sky130_fd_sc_hd__a211oi_4 _4825_ (.A1(_1275_),
    .A2(_1277_),
    .B1(_1394_),
    .C1(_1395_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1396_));
 sky130_fd_sc_hd__o211a_1 _4826_ (.A1(_1394_),
    .A2(_1395_),
    .B1(_1275_),
    .C1(_1277_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211oi_4 _4827_ (.A1(_1340_),
    ...
    .VPWR(VPWR),
    .Y(_1398_));
 sky130_fd_sc_hd__o211a_1 _4828_ (.A1(_1396_),
    .A2(_1397_),
    .B1(_1340_),
    .C1(_1341_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1399_));
 sky130_fd_sc_hd__or3_1 _4829_ (.A(_0918_),
    .B(_1398_),
    .C(_1399_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _4845_ (.A(_2619_),
    ...
    .VPWR(VPWR),
    .X(_1415_));
 sky130_fd_sc_hd__a21o_1 _4846_ (.A1(_1143_),
    .A2(_1373_),
    .B1(_1415_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _4854_ (.A(_1410_),
    ...
    .VPWR(VPWR),
    .Y(_1424_));
 sky130_fd_sc_hd__or2_1 _4855_ (.A(_1367_),
    .B(_1389_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _4874_ (.A(_1143_),
    ...
    .VPWR(VPWR),
    .Y(_1444_));
 sky130_fd_sc_hd__clkbuf_4 _4875_ (.A(_1444_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _4877_ (.A(\u_interface.u_compute_core.relu_data[13] ),
    ...
    .VPWR(VPWR),
    .Y(_1447_));
 sky130_fd_sc_hd__nand4_1 _4878_ (.A(_2634_),
    .B(_2631_),
    .C(_0557_),
    .D(_0595_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4887_ (.A1(_1454_),
    ...
    .VPWR(VPWR),
    .X(_1457_));
 sky130_fd_sc_hd__nand3_1 _4888_ (.A(_1445_),
    .B(_1456_),
    .C(_1457_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _4889_ (.A1(_1456_),
    ...
    .VPWR(VPWR),
    .X(_1459_));
 sky130_fd_sc_hd__and3_1 _4890_ (.A(_1365_),
    .B(_1458_),
    .C(_1459_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4891_ (.A1(_1458_),
    ...
    .VPWR(VPWR),
    .Y(_1461_));
 sky130_fd_sc_hd__or3_1 _4892_ (.A(_1441_),
    .B(_1460_),
    .C(_1461_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _4893_ (.A1(_1460_),
    ...
    .VPWR(VPWR),
    .Y(_1463_));
 sky130_fd_sc_hd__and3_1 _4894_ (.A(_1439_),
    .B(_1462_),
    .C(_1463_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4895_ (.A1(_1462_),
    ...
    .VPWR(VPWR),
    .Y(_1465_));
 sky130_fd_sc_hd__or3_2 _4896_ (.A(_1425_),
    .B(_1464_),
    .C(_1465_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1466_));
 sky130_fd_sc_hd__o21ai_1 _4897_ (.A1(_1464_),
    .A2(_1465_),
    .B1(_1425_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1467_));
 sky130_fd_sc_hd__and3_1 _4898_ (.A(_1424_),
    .B(_1466_),
    .C(_1467_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4899_ (.A1(_1466_),
    ...
    .VPWR(VPWR),
    .Y(_1469_));
 sky130_fd_sc_hd__a211oi_1 _4900_ (.A1(_1409_),
    .A2(_1392_),
    .B1(_1468_),
    .C1(_1469_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1470_));
 sky130_fd_sc_hd__o211a_1 _4901_ (.A1(_1468_),
    .A2(_1469_),
    .B1(_1409_),
    .C1(_1392_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _4906_ (.A(_1474_),
    ...
    .VPWR(VPWR),
    .Y(_1476_));
 sky130_fd_sc_hd__xnor2_1 _4907_ (.A(_0982_),
    .B(_1476_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1477_));
 sky130_fd_sc_hd__nand2b_1 _4908_ (.A_N(_1398_),
    .B(_1400_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1478_));
 sky130_fd_sc_hd__xnor2_1 _4909_ (.A(_1477_),
    .B(_1478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1479_));
 sky130_fd_sc_hd__nand4bb_1 _4910_ (.A_N(_1404_),
    .B_N(_1331_),
    .C(_1330_),
    .D(_1403_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _4911_ (.A(_1328_),
    ...
    .VPWR(VPWR),
    .X(_1481_));
 sky130_fd_sc_hd__a311o_1 _4912_ (.A1(_1330_),
    .A2(_1333_),
    .A3(_1403_),
    .B1(_1404_),
    .C1(_1481_),
 ...
 sky130_fd_sc_hd__o21bai_1 _4924_ (.A1(_1441_),
    ...
    .VPWR(VPWR),
    .Y(_1493_));
 sky130_fd_sc_hd__a21o_1 _4925_ (.A1(_1143_),
    .A2(_1442_),
    .B1(_1415_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4_1 _4939_ (.A(\u_interface.u_compute_core.relu_data[21] ),
    ...
    .VPWR(VPWR),
    .X(_1508_));
 sky130_fd_sc_hd__buf_2 _4940_ (.A(\u_interface.u_compute_core.relu_data[21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and4_1 _4955_ (.A(_2634_),
    ...
    .VPWR(VPWR),
    .X(_1524_));
 sky130_fd_sc_hd__or3_1 _4956_ (.A(_1447_),
    .B(_1523_),
    .C(_1524_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _4958_ (.A(_1522_),
    ...
    .VPWR(VPWR),
    .Y(_1527_));
 sky130_fd_sc_hd__a21o_1 _4959_ (.A1(_1525_),
    .A2(_1526_),
    .B1(_1522_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _4969_ (.A1(_1535_),
    ...
    .VPWR(VPWR),
    .Y(_1538_));
 sky130_fd_sc_hd__or3_2 _4970_ (.A(_1517_),
    .B(_1537_),
    .C(_1538_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _4971_ (.A1(_1537_),
    ...
    .VPWR(VPWR),
    .Y(_1540_));
 sky130_fd_sc_hd__and3_1 _4972_ (.A(_1464_),
    .B(_1539_),
    .C(_1540_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a211oi_2 _4978_ (.A1(_1487_),
    ...
    .VPWR(VPWR),
    .Y(_1547_));
 sky130_fd_sc_hd__o211a_1 _4979_ (.A1(_1545_),
    .A2(_1546_),
    .B1(_1487_),
    .C1(_1488_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1548_));
 sky130_fd_sc_hd__a211oi_4 _4980_ (.A1(_1486_),
    .A2(_1472_),
    .B1(_1547_),
    .C1(_1548_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1549_));
 sky130_fd_sc_hd__o211a_1 _4981_ (.A1(_1547_),
    .A2(_1548_),
    .B1(_1486_),
    .C1(_1472_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1550_));
 sky130_fd_sc_hd__or3_1 _4982_ (.A(_0918_),
    .B(_1549_),
    .C(_1550_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1551_));
 sky130_fd_sc_hd__o21ai_1 _4983_ (.A1(_1549_),
    .A2(_1550_),
    .B1(_0982_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1552_));
 sky130_fd_sc_hd__a21o_1 _4984_ (.A1(_1042_),
    .A2(_1476_),
    .B1(_1474_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _5027_ (.A(_1594_),
    ...
    .VPWR(VPWR),
    .Y(_1595_));
 sky130_fd_sc_hd__and3_2 _5028_ (.A(_2634_),
    .B(\u_interface.u_compute_core.relu_data[14] ),
    .C(_0632_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _5029_ (.A1(_2634_),
    ...
    .VPWR(VPWR),
    .Y(_1597_));
 sky130_fd_sc_hd__or3_1 _5030_ (.A(_1447_),
    .B(_1596_),
    .C(_1597_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1598_));
 sky130_fd_sc_hd__clkbuf_2 _5031_ (.A(_1598_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _5035_ (.A1(_1599_),
    ...
    .VPWR(VPWR),
    .Y(_1603_));
 sky130_fd_sc_hd__or3_1 _5036_ (.A(_1595_),
    .B(_1602_),
    .C(_1603_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _5039_ (.A(_1604_),
    ...
    .VPWR(VPWR),
    .Y(_1607_));
 sky130_fd_sc_hd__a21o_1 _5040_ (.A1(_1604_),
    .A2(_1605_),
    .B1(_1606_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _5041_ (.A(_1593_),
    ...
    .VPWR(VPWR),
    .Y(_1609_));
 sky130_fd_sc_hd__a21o_1 _5042_ (.A1(_1607_),
    .A2(_1608_),
    .B1(_1445_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _5043_ (.A(_1515_),
    ...
    .VPWR(VPWR),
    .Y(_1611_));
 sky130_fd_sc_hd__a21o_1 _5044_ (.A1(_1609_),
    .A2(_1610_),
    .B1(_1515_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand3_1 _5045_ (.A(_1592_),
    ...
    .VPWR(VPWR),
    .Y(_1613_));
 sky130_fd_sc_hd__a21o_1 _5046_ (.A1(_1611_),
    .A2(_1612_),
    .B1(_1592_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1614_));
 sky130_fd_sc_hd__and3_1 _5047_ (.A(_1591_),
    .B(_1613_),
    .C(_1614_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor3_1 _5049_ (.A(_1539_),
    ...
    .VPWR(VPWR),
    .Y(_1617_));
 sky130_fd_sc_hd__o21a_1 _5050_ (.A1(_1615_),
    .A2(_1616_),
    .B1(_1539_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1618_));
 sky130_fd_sc_hd__or3_2 _5051_ (.A(_1569_),
    .B(_1617_),
    .C(_1618_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211ai_2 _5053_ (.A1(_1541_),
    ...
    .VPWR(VPWR),
    .Y(_1621_));
 sky130_fd_sc_hd__a211o_1 _5054_ (.A1(_1619_),
    .A2(_1620_),
    .B1(_1541_),
    .C1(_1543_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211ai_1 _5055_ (.A1(_1561_),
    ...
    .VPWR(VPWR),
    .Y(_1623_));
 sky130_fd_sc_hd__a211o_1 _5056_ (.A1(_1621_),
    .A2(_1622_),
    .B1(_1561_),
    .C1(_1562_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1624_));
 sky130_fd_sc_hd__nand2_1 _5057_ (.A(_1623_),
    .B(_1624_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _5061_ (.A_N(_1549_),
    ...
    .VPWR(VPWR),
    .X(_1629_));
 sky130_fd_sc_hd__xnor2_1 _5062_ (.A(_1628_),
    .B(_1629_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1630_));
 sky130_fd_sc_hd__or3_1 _5063_ (.A(_1479_),
    .B(_1554_),
    .C(_1555_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _5065_ (.A1(_1483_),
    ...
    .VPWR(VPWR),
    .X(_1633_));
 sky130_fd_sc_hd__xnor2_1 _5066_ (.A(_1630_),
    .B(_1633_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _5069_ (.A(_1625_),
    ...
    .VPWR(VPWR),
    .Y(_1636_));
 sky130_fd_sc_hd__a21o_1 _5070_ (.A1(_1042_),
    .A2(_1627_),
    .B1(_1636_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1637_));
 sky130_fd_sc_hd__nand2_1 _5071_ (.A(_1621_),
    .B(_1623_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1638_));
 sky130_fd_sc_hd__clkbuf_4 _5072_ (.A(_1566_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _5104_ (.A(_1599_),
    ...
    .VPWR(VPWR),
    .X(_1671_));
 sky130_fd_sc_hd__a21oi_1 _5105_ (.A1(_1599_),
    .A2(_1600_),
    .B1(_1670_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _5123_ (.A1(_1592_),
    ...
    .VPWR(VPWR),
    .X(_1690_));
 sky130_fd_sc_hd__xor2_1 _5124_ (.A(_1566_),
    .B(_1690_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _5130_ (.A(_1695_),
    ...
    .VPWR(VPWR),
    .Y(_1697_));
 sky130_fd_sc_hd__xnor2_1 _5131_ (.A(_1641_),
    .B(_1697_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _5132_ (.A(_1638_),
    ...
    .VPWR(VPWR),
    .Y(_1699_));
 sky130_fd_sc_hd__xnor2_1 _5133_ (.A(_1042_),
    .B(_1699_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _5136_ (.A1(_1630_),
    ...
    .VPWR(VPWR),
    .X(_1703_));
 sky130_fd_sc_hd__xnor2_1 _5137_ (.A(_1701_),
    .B(_1703_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _5139_ (.A1(_0571_),
    ...
    .VPWR(VPWR),
    .X(_0129_));
 sky130_fd_sc_hd__or2b_1 _5140_ (.A(_1630_),
    .B_N(_1701_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1706_));
 sky130_fd_sc_hd__or3b_1 _5141_ (.A(_1631_),
    .B(_1706_),
    .C_N(_1482_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_1707_));
 sky130_fd_sc_hd__or4_1 _5142_ (.A(_1185_),
    .B(_1480_),
    .C(_1631_),
    .D(_1706_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1708_));
 sky130_fd_sc_hd__nor2_1 _5143_ (.A(_1637_),
    .B(_1700_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1709_));
 sky130_fd_sc_hd__nand2_1 _5144_ (.A(_1637_),
    .B(_1700_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ba_1 _5147_ (.A1(_1641_),
    ...
    .VPWR(VPWR),
    .X(_1713_));
 sky130_fd_sc_hd__or2b_1 _5148_ (.A(_1566_),
    .B_N(_1690_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _5150_ (.A1(_1667_),
    ...
    .VPWR(VPWR),
    .X(_1716_));
 sky130_fd_sc_hd__xor2_1 _5151_ (.A(_1566_),
    .B(_1716_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _5185_ (.A1(_1599_),
    ...
    .VPWR(VPWR),
    .Y(_1751_));
 sky130_fd_sc_hd__or3_1 _5186_ (.A(_1669_),
    .B(_1750_),
    .C(_1751_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _5190_ (.A1(_1752_),
    ...
    .VPWR(VPWR),
    .X(_1756_));
 sky130_fd_sc_hd__and3_1 _5191_ (.A(_1445_),
    .B(_1755_),
    .C(_1756_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _5192_ (.A1(_1755_),
    ...
    .VPWR(VPWR),
    .Y(_1758_));
 sky130_fd_sc_hd__or3_1 _5193_ (.A(_1748_),
    .B(_1757_),
    .C(_1758_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _5203_ (.A1(_1686_),
    ...
    .VPWR(VPWR),
    .X(_1769_));
 sky130_fd_sc_hd__a211oi_1 _5204_ (.A1(_1767_),
    .A2(_1768_),
    .B1(_1686_),
    .C1(net63),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1770_));
 sky130_fd_sc_hd__nor3_1 _5205_ (.A(_1715_),
    .B(_1769_),
    .C(_1770_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _5217_ (.A1(_0571_),
    ...
    .VPWR(VPWR),
    .X(_0130_));
 sky130_fd_sc_hd__or2b_1 _5218_ (.A(_1566_),
    .B_N(_1716_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _5263_ (.A(_1599_),
    ...
    .VPWR(VPWR),
    .X(_1828_));
 sky130_fd_sc_hd__a21oi_1 _5264_ (.A1(_1599_),
    .A2(_1600_),
    .B1(_1827_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _5277_ (.A1(_1823_),
    ...
    .VPWR(VPWR),
    .X(_1842_));
 sky130_fd_sc_hd__o211a_1 _5278_ (.A1(_1787_),
    .A2(_1788_),
    .B1(_1841_),
    .C1(_1842_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1843_));
 sky130_fd_sc_hd__a211oi_1 _5279_ (.A1(_1841_),
    .A2(_1842_),
    .B1(_1787_),
    .C1(_1788_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _5280_ (.A1(_1747_),
    ...
    .VPWR(VPWR),
    .X(_1845_));
 sky130_fd_sc_hd__xor2_1 _5281_ (.A(_1566_),
    .B(_1845_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _5282_ (.A(_1689_),
    ...
    .VPWR(VPWR),
    .Y(_1847_));
 sky130_fd_sc_hd__or3_1 _5283_ (.A(_1843_),
    .B(_1844_),
    .C(_1847_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21boi_1 _5288_ (.A1(_1850_),
    ...
    .VPWR(VPWR),
    .Y(_1853_));
 sky130_fd_sc_hd__nor2_1 _5289_ (.A(_1852_),
    .B(_1853_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _5341_ (.A1(_1902_),
    ...
    .VPWR(VPWR),
    .Y(_1905_));
 sky130_fd_sc_hd__a21bo_1 _5342_ (.A1(_1445_),
    .A2(_1834_),
    .B1_N(_1833_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _5346_ (.A1(_1655_),
    ...
    .VPWR(VPWR),
    .Y(_1910_));
 sky130_fd_sc_hd__nand3_1 _5347_ (.A(_1599_),
    .B(_1600_),
    .C(_1910_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_1911_));
 sky130_fd_sc_hd__a21o_1 _5348_ (.A1(_1599_),
    .A2(_1600_),
    .B1(_1910_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _5353_ (.A1(_1913_),
    ...
    .VPWR(VPWR),
    .X(_1917_));
 sky130_fd_sc_hd__nand3_1 _5354_ (.A(_1445_),
    .B(_1916_),
    .C(_1917_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21boi_2 _5364_ (.A1(_1825_),
    ...
    .VPWR(VPWR),
    .Y(_1928_));
 sky130_fd_sc_hd__xnor2_1 _5365_ (.A(_1566_),
    .B(_1928_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _5368_ (.A1(_1926_),
    ...
    .VPWR(VPWR),
    .Y(_1932_));
 sky130_fd_sc_hd__o211a_1 _5369_ (.A1(_1843_),
    .A2(_1868_),
    .B1(_1931_),
    .C1(_1932_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _5448_ (.A(_1920_),
    ...
    .VPWR(VPWR),
    .Y(_2011_));
 sky130_fd_sc_hd__xnor2_1 _5449_ (.A(_1566_),
    .B(_2011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o221a_1 _5474_ (.A1(_1945_),
    ...
    .VPWR(VPWR),
    .X(_2036_));
 sky130_fd_sc_hd__a311o_1 _5475_ (.A1(_1707_),
    .A2(_1708_),
    .A3(_1711_),
    .B1(_1948_),
    .C1(_2034_),
 ...
 sky130_fd_sc_hd__nand2_1 _5536_ (.A(_2096_),
    ...
    .VPWR(VPWR),
    .Y(_2098_));
 sky130_fd_sc_hd__xor2_1 _5537_ (.A(_1566_),
    .B(_2098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _5555_ (.A(_2115_),
    ...
    .VPWR(VPWR),
    .Y(_2117_));
 sky130_fd_sc_hd__a21o_1 _5556_ (.A1(_2036_),
    .A2(_2037_),
    .B1(_2117_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _5689_ (.A(_2242_),
    ...
    .VPWR(VPWR),
    .X(_2248_));
 sky130_fd_sc_hd__a311o_1 _5690_ (.A1(_2115_),
    .A2(_2118_),
    .A3(_2186_),
    .B1(_2244_),
    .C1(_2185_),
 ...
 sky130_fd_sc_hd__a21oi_1 _5740_ (.A1(_2248_),
    ...
    .VPWR(VPWR),
    .Y(_2299_));
 sky130_fd_sc_hd__a31o_1 _5741_ (.A1(_2248_),
    .A2(_2249_),
    .A3(_2298_),
    .B1(_2735_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _5753_ (.A1(_2306_),
    ...
    .VPWR(VPWR),
    .Y(_2310_));
 sky130_fd_sc_hd__o211a_1 _5754_ (.A1(\u_interface.core_attn_out[1] ),
    .A2(_2304_),
    .B1(_0981_),
    .C1(_2310_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _5761_ (.A1(_2315_),
    ...
    .VPWR(VPWR),
    .Y(_2317_));
 sky130_fd_sc_hd__o211a_1 _5762_ (.A1(\u_interface.core_attn_out[2] ),
    .A2(_2304_),
    .B1(_0981_),
    .C1(_2317_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _5795_ (.A1(_2345_),
    ...
    .VPWR(VPWR),
    .X(_2347_));
 sky130_fd_sc_hd__o211a_1 _5796_ (.A1(\u_interface.core_attn_out[6] ),
    .A2(_2304_),
    .B1(_0981_),
    .C1(_2347_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _5802_ (.A1(_2351_),
    ...
    .VPWR(VPWR),
    .Y(_2353_));
 sky130_fd_sc_hd__o211a_1 _5803_ (.A1(\u_interface.core_attn_out[7] ),
    .A2(_2304_),
    .B1(_0981_),
    .C1(_2353_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _5816_ (.A1(_2355_),
    ...
    .VPWR(VPWR),
    .X(_2365_));
 sky130_fd_sc_hd__o221a_1 _5817_ (.A1(\u_interface.core_attn_out[9] ),
    .A2(_2304_),
    .B1(_2364_),
    .B2(_2365_),
    .C1(_0855_),
 ...
 sky130_fd_sc_hd__a21o_1 _5832_ (.A1(_2376_),
    ...
    .VPWR(VPWR),
    .X(_2379_));
 sky130_fd_sc_hd__o221a_1 _5833_ (.A1(\u_interface.core_attn_out[11] ),
    .A2(_2304_),
    .B1(_2378_),
    .B2(_2379_),
    .C1(_0855_),
 ...
 sky130_fd_sc_hd__a21o_1 _5847_ (.A1(_2389_),
    ...
    .VPWR(VPWR),
    .X(_2392_));
 sky130_fd_sc_hd__o221a_1 _5848_ (.A1(\u_interface.core_attn_out[13] ),
    .A2(_2309_),
    .B1(_2391_),
    .B2(_2392_),
    .C1(_0855_),
 ...
 sky130_fd_sc_hd__a31o_1 _5862_ (.A1(_2394_),
    ...
    .VPWR(VPWR),
    .X(_2405_));
 sky130_fd_sc_hd__o221a_1 _5863_ (.A1(\u_interface.core_attn_out[15] ),
    .A2(_2309_),
    .B1(_2404_),
    .B2(_2405_),
    .C1(_0855_),
 ...
 sky130_fd_sc_hd__a31o_1 _5878_ (.A1(_2407_),
    ...
    .VPWR(VPWR),
    .X(_2419_));
 sky130_fd_sc_hd__o221a_1 _5879_ (.A1(\u_interface.core_attn_out[17] ),
    .A2(_2309_),
    .B1(_2418_),
    .B2(_2419_),
    .C1(_0855_),
 ...
 sky130_fd_sc_hd__a21o_1 _5886_ (.A1(_2424_),
    ...
    .VPWR(VPWR),
    .X(_2426_));
 sky130_fd_sc_hd__o211a_1 _5887_ (.A1(\u_interface.core_attn_out[18] ),
    .A2(_2304_),
    .B1(_0981_),
    .C1(_2426_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _5894_ (.A1(_2427_),
    ...
    .VPWR(VPWR),
    .Y(_2433_));
 sky130_fd_sc_hd__o221a_1 _5895_ (.A1(\u_interface.core_attn_out[19] ),
    .A2(_2309_),
    .B1(_2430_),
    .B2(_2433_),
    .C1(_0486_),
 ...
 sky130_fd_sc_hd__a31o_1 _5908_ (.A1(_2436_),
    ...
    .VPWR(VPWR),
    .X(_2445_));
 sky130_fd_sc_hd__o221a_1 _5909_ (.A1(\u_interface.core_attn_out[21] ),
    .A2(_2309_),
    .B1(_2444_),
    .B2(_2445_),
    .C1(_0486_),
 ...
 sky130_fd_sc_hd__a21o_1 _5918_ (.A1(_2452_),
    ...
    .VPWR(VPWR),
    .X(_2454_));
 sky130_fd_sc_hd__o211a_1 _5919_ (.A1(\u_interface.core_attn_out[22] ),
    .A2(_2304_),
    .B1(_0981_),
    .C1(_2454_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _5924_ (.A1(_2447_),
    ...
    .VPWR(VPWR),
    .X(_2459_));
 sky130_fd_sc_hd__o221a_1 _5925_ (.A1(\u_interface.core_attn_out[23] ),
    .A2(_2309_),
    .B1(_2458_),
    .B2(_2459_),
    .C1(_0486_),
 ...
 sky130_fd_sc_hd__o21ai_1 _5950_ (.A1(_2480_),
    ...
    .VPWR(VPWR),
    .Y(_2482_));
 sky130_fd_sc_hd__o211a_1 _5951_ (.A1(\u_interface.core_attn_out[26] ),
    .A2(_2304_),
    .B1(_0981_),
    .C1(_2482_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _5965_ (.A1(_2493_),
    ...
    .VPWR(VPWR),
    .Y(_2495_));
 sky130_fd_sc_hd__o211a_1 _5966_ (.A1(\u_interface.core_attn_out[28] ),
    .A2(_2304_),
    .B1(_0981_),
    .C1(_2495_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfxtp_1 _6258_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net60));
 sky130_fd_sc_hd__dfxtp_1 _6259_ (.CLK(clk),
    .D(_0172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net28));
 sky130_fd_sc_hd__dfxtp_1 _6260_ (.CLK(clk),
    .D(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net39));
 sky130_fd_sc_hd__dfxtp_1 _6261_ (.CLK(clk),
    .D(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net50));
 sky130_fd_sc_hd__dfxtp_1 _6262_ (.CLK(clk),
    .D(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net53));
 sky130_fd_sc_hd__dfxtp_1 _6263_ (.CLK(clk),
    .D(_0176_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net54));
 sky130_fd_sc_hd__dfxtp_1 _6264_ (.CLK(clk),
    .D(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net55));
 sky130_fd_sc_hd__dfxtp_1 _6265_ (.CLK(clk),
    .D(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net56));
 sky130_fd_sc_hd__dfxtp_1 _6266_ (.CLK(clk),
    .D(_0179_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net57));
 sky130_fd_sc_hd__dfxtp_1 _6267_ (.CLK(clk),
    .D(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net58));
 sky130_fd_sc_hd__dfxtp_1 _6268_ (.CLK(clk),
    .D(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_1 _6269_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net29));
 sky130_fd_sc_hd__dfxtp_1 _6270_ (.CLK(clk),
    .D(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net30));
 sky130_fd_sc_hd__dfxtp_1 _6271_ (.CLK(clk),
    .D(_0184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net31));
 sky130_fd_sc_hd__dfxtp_1 _6272_ (.CLK(clk),
    .D(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net32));
 sky130_fd_sc_hd__dfxtp_1 _6273_ (.CLK(clk),
    .D(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net33));
 sky130_fd_sc_hd__dfxtp_1 _6274_ (.CLK(clk),
    .D(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net34));
 sky130_fd_sc_hd__dfxtp_1 _6275_ (.CLK(clk),
    .D(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net35));
 sky130_fd_sc_hd__dfxtp_1 _6276_ (.CLK(clk),
    .D(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net36));
 sky130_fd_sc_hd__dfxtp_1 _6277_ (.CLK(clk),
    .D(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net37));
 sky130_fd_sc_hd__dfxtp_1 _6278_ (.CLK(clk),
    .D(_0191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net38));
 sky130_fd_sc_hd__dfxtp_1 _6279_ (.CLK(clk),
    .D(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net40));
 sky130_fd_sc_hd__dfxtp_1 _6280_ (.CLK(clk),
    .D(_0193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net41));
 sky130_fd_sc_hd__dfxtp_1 _6281_ (.CLK(clk),
    .D(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net42));
 sky130_fd_sc_hd__dfxtp_1 _6282_ (.CLK(clk),
    .D(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net43));
 sky130_fd_sc_hd__dfxtp_1 _6283_ (.CLK(clk),
    .D(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net44));
 sky130_fd_sc_hd__dfxtp_1 _6284_ (.CLK(clk),
    .D(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net45));
 sky130_fd_sc_hd__dfxtp_1 _6285_ (.CLK(clk),
    .D(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net46));
 sky130_fd_sc_hd__dfxtp_1 _6286_ (.CLK(clk),
    .D(_0199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net47));
 sky130_fd_sc_hd__dfxtp_1 _6287_ (.CLK(clk),
    .D(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net48));
 sky130_fd_sc_hd__dfxtp_1 _6288_ (.CLK(clk),
    .D(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net49));
 sky130_fd_sc_hd__dfxtp_1 _6289_ (.CLK(clk),
    .D(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net51));
 sky130_fd_sc_hd__dfxtp_1 _6290_ (.CLK(clk),
    .D(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap64 (.A(_0564_),
    ...
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__buf_1 max_cap65 (.A(_0582_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
